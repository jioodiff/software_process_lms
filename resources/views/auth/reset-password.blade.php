...
<head>
    ...
    <title>Reset Password - {{ config('app.name', 'Lab Management System') }}</title>
            ...
            <div class="w-full md:w-1/2 p-8 sm:p-12 flex flex-col justify-start items-center bg-white relative">
                ...
                <div class="w-full max-w-sm mt-4 lg:mt-8">
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-2xl lg:text-3xl font-bold tracking-tight text-slate-900 mb-2">Reset Password</h2>
                        <p class="text-sm text-slate-500">Silakan masukkan password baru Anda.</p>
                    </div>

                    <form method="POST" action="{{ route('password.update') }}" class="space-y-5 w-full">
                        @csrf
                        ...
                        <div x-data="{ show: false }">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 flex items-center pr-4 text-slate-400 hover:text-blue-600 transition-colors focus:outline-none">
