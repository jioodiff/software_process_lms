            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                <div>
                    ...
                    <div class="relative w-full">
                        <select name="tipe_mutasi" required class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10 appearance-none" onchange="document.getElementById('tipe-mutasi-text').innerText = this.options[this.selectedIndex].text">
                        ...
                        <div class="flex items-center justify-between w-full rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm shadow-sm transition-colors">
                            <span id="tipe-mutasi-text">Masuk (Tambah Stok)</span>
