...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-8">
    ...
    <div class="bg-white rounded-2xl shadow-[0_2px_10px_rgb(0,0,0,0.02)] border border-slate-100 p-6 flex items-center hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300 relative overflow-hidden group">
        ...
        <div class="ml-5 relative z-10 flex-1">
            <p class="text-sm font-medium text-slate-500 mb-1 min-h-[40px]">Total Alat</p>
    ...
    <div class="bg-white rounded-2xl shadow-[0_2px_10px_rgb(0,0,0,0.02)] border border-slate-100 p-6 flex items-center hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300 relative overflow-hidden group">
        ...
        <div class="ml-5 relative z-10 flex-1">
            <p class="text-sm font-medium text-slate-500 mb-1 min-h-[40px]">Stok Tersedia</p>
    ...
    <div class="bg-white rounded-2xl shadow-[0_2px_10px_rgb(0,0,0,0.02)] border border-slate-100 p-6 flex items-center hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300 relative overflow-hidden group">
        ...
        <div class="ml-5 relative z-10 flex-1">
            <p class="text-sm font-medium text-slate-500 mb-1 min-h-[40px]">Menunggu Approve</p>
            <div class="flex items-end justify-between gap-2">
                <h3 class="text-3xl font-bold text-slate-900 leading-none">{{ number_format($stats['peminjaman_menunggu']) }}</h3>
                <a href="{{ route('admin.borrowings.index', ['status' => 'Menunggu Persetujuan']) }}" class="text-[10px] font-bold text-amber-600 bg-amber-50 hover:bg-amber-100 transition-colors px-2 py-1 rounded-md flex items-center gap-1 shrink-0">
    ...
    <div class="bg-white rounded-2xl shadow-[0_2px_10px_rgb(0,0,0,0.02)] border border-slate-100 p-6 flex items-center hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300 relative overflow-hidden group">
        ...
        <div class="ml-5 relative z-10 flex-1">
            <p class="text-sm font-medium text-slate-500 mb-1 min-h-[40px]">Terlambat Kembali</p>
            <div class="flex items-end justify-between gap-2">
                <h3 class="text-3xl font-bold text-slate-900 leading-none">{{ number_format($stats['overdue']) }}</h3>
                <a href="{{ route('admin.borrowings.index', ['status' => 'Terlambat']) }}" class="text-[10px] font-bold text-red-600 bg-red-50 hover:bg-red-100 transition-colors px-2 py-1 rounded-md flex items-center gap-1 shrink-0">
                    Kelola <i data-lucide="arrow-right" class="w-3 h-3"></i>
                </a>
            </div>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-[0_2px_10px_rgb(0,0,0,0.02)] border border-slate-100 p-6 flex items-center hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300 relative overflow-hidden group">
        ...
        <div class="ml-5 relative z-10 flex-1">
            <p class="text-sm font-medium text-slate-500 mb-1 min-h-[40px]">Total Pengguna</p>
            <div class="flex items-end justify-between gap-2">
