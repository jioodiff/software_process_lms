        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="relative w-full">
                    <select name="kondisi" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10 appearance-none" onchange="document.getElementById('kondisi-text-edit').innerText = this.options[this.selectedIndex].text">
                        ...
                        <option value="Dalam Perbaikan" {{ old('kondisi', $item->kondisi) == 'Dalam Perbaikan' ? 'selected' : '' }}>Dalam Perbaikan</option>
                    </select>
                    <div class="flex items-center justify-between w-full rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm shadow-sm transition-colors">
                        <span id="kondisi-text-edit">{{ old('kondisi', $item->kondisi) ?: 'Baik' }}</span>
