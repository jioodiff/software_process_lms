...
<body class="h-full flex overflow-hidden">
    ...
    <div class="w-72 bg-white flex flex-col hidden md:flex shrink-0 border-r border-slate-200 relative z-20">
        ...
        <div class="flex-1 overflow-y-auto py-6 px-4 space-y-1">
            ...
            @else
                <p class="px-2 text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-2 mt-2">Mahasiswa</p>
            ...
            <div class="max-w-7xl mx-auto w-full flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="flex items-center gap-2 p-2.5 bg-white border border-slate-200 text-slate-400 hover:text-blue-600 hover:border-blue-300 rounded-full transition-all shadow-sm relative">
